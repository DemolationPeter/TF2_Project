...
#MODELS_DIR = '/home/marinfrede/Dokumente/Studienarbeit/Projekt/models/research/object_detection/workspace/exported-models'
MODELS_DIR = '/home/marinfrede/Dokumente/Studienarbeit/Projekt/workspace/exported-models'
...
#LABEL_DIR = '/home/marinfrede/Dokumente/Studienarbeit/Projekt/models/research/object_detection/workspace/annotations'
...
while True:
    ...
    # frame = np.tile(
    #     np.mean(frame, 2, keepdims=True), (1, 1, 3)).astype(np.uint8)
    ...
    cv2.putText(frame_with_detections, fps, (5, 30), font, 1, (000, 000, 000), 2, cv2.LINE_AA)          
    #image = cv2.putText(image, 'OpenCV', org, font, fontScale, color, thickness, cv2.LINE_AA) 


    # Display output
    #cv2.imshow('object detection', cv2.resize(frame_with_detections, (1280, 720)))			#keine Ahnung wieso man resize machen sollte???
